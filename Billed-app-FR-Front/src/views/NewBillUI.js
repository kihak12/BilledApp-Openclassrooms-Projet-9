            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <label class="bold-label" id="invalid-file" data-testid="invalid-file" style="display: none">Fichier invalide, uniquement les fichiers au format PNG/JPG/JPEG sont autorisés</label>
                  </div>
                </div>
            </div>
            <div class="row">
